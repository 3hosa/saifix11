...
class _HomeScreenState extends State<HomeScreen>
  ...
  // State for Account Confirmation
  ...
  Widget _buildHomeContent() {
    return Column(
      ...
      children: [
        if (!_isAccountConfirmed && !_isKycPending) _buildConfirmationBanner(),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Colors.red.withValues(alpha: 0.1), blurRadius: 10),
          ],
        ),
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'click_here_confirm_your_wallet'.tr(),
                style: TextStyle(
                  color: Colors.red,
                  fontWeight: FontWeight.bold,
                  fontSize: 14,
