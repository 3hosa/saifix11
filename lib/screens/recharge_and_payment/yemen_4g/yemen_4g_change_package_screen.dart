...
class Yemen4GChangePackageScreen extends StatefulWidget {
  final bool isDarkMode;
  final String title;

  const Yemen4GChangePackageScreen({
    super.key,
  ...
  @override
  State<Yemen4GChangePackageScreen> createState() =>
      _Yemen4GChangePackageScreenState();
}

class _Yemen4GChangePackageScreenState
    extends State<Yemen4GChangePackageScreen> {
  ...
  final List<Map<String, dynamic>> _voicePackages = [
    {'id': 'v1', 'name': 'voice_package_1000'.tr(), 'price': 1000.0},
    {'id': 'v2', 'name': 'voice_package_2000'.tr(), 'price': 2000.0},
    {'id': 'v3', 'name': 'voice_package_3000'.tr(), 'price': 3000.0},
    {'id': 'v4', 'name': 'voice_package_4000'.tr(), 'price': 4000.0},
  ];
  ...
  void initState() {
    super.initState();
    _currentPackages =
        widget.title.contains('صوت') ? _voicePackages : _dataPackages;
  ...
  void _showBalanceDetails(Map<String, dynamic> result) {
    ...
    String expiry =
        (data['ExpDate'] ??
                ...
                'N/A')
            .toString();
    String minAmt = (data['LessAmt'] ?? data['LESSAMT'] ?? '').toString();
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              if (minAmt.isNotEmpty)
                _buildBalanceRow(
                  'required_amount_label'.tr(),
                  '$minAmt ${'currency_riyal'.tr()}',
                ),
